...
- cloud provider as AWS:
     ...
     Please note that you will need more that t2.micro type of instance because of number of the containers. You will need more that 1Gb of RAM and at least 8Gb of disk free space depends of the used Linux distro.
